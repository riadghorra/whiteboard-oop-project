...
'''
Ouverture de la configuration initiale stockée dans config.json qui contient le mode d'écriture, la couleur et la
 taille d'écriture. 
...
def main():
    ...
    '''
    whiteboard = WhiteBoard("client2", start_config, hist)
